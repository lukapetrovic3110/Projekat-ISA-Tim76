...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().exceptionHandling()
				...
				.antMatchers("/auth/*", "/admin/registrationRequests", "/admin", "/admin/declineRegistrationRequest", "/admin/acceptRegistrationRequest", "/client/*", "/deleteAccount/*", "/cottage/*", "/cottage", "/reservationCottage/*", "/ship", "/ship/*", "/reservationShip/*", "/adventure", "/reservationAdventure/*", "/adventure/*" ,"/image/upload/*/*").permitAll()
