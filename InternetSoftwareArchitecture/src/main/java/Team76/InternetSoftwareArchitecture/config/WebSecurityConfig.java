...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().exceptionHandling()
				...
				.antMatchers("/auth/*", "/admin/registrationRequests", "/admin", "/admin/declineRegistrationRequest", "/admin/acceptRegistrationRequest", "/client/*", "/deleteAccount/*", "/cottage/*", "/cottage", "/cottage/findCottage/*", "/reservationCottage/*", "/cottage/findAvailableCottagesForSelectedDateIntervalAndNumberOfGuests/*/*/*", "/ship/findAvailableShipsForSelectedDateIntervalAndNumberOfGuests/*/*/*", "/ship", "/ship/*", "/ship/findShip/*", "/reservationShip/*", "/adventure", "/adventure/findAdventure/*", "/findAvailableAdventuresForSelectedDateIntervalAndNumberOfGuests/*/*/*", "/reservationAdventure/*", "/reservationAdditionalService/*", "/adventure/*" ,"/image/upload/*/*", "/image/getImages/*/*", "/complaint/*", "/revision/*", "/user/findByEmail/*").permitAll()
