...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().exceptionHandling()
				...
				.antMatchers("/auth/signupClient", "/auth/signupCottageOwner", "/auth/signupShipOwner", "/auth/signupFishingInstructor", "/auth/login", "/auth/verify", "/auth/confirm_account/*", "/admin/registrationRequests", "/admin/declineRegistrationRequest", "/admin/acceptRegistrationRequest").permitAll()
